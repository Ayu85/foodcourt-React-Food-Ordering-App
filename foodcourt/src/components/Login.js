...
const Login = () => {
    return (
        <div className='relative'>
            <div className='absolute z-50 bg-gradient-to-l backdrop-blur-sm from-[#ffd5d484] to-[#fff4f38d]  w-screen px-10 py-1'><img src={logo} alt='logo' /></div>
            <div className='absolute h-screen filter brightness-50'><iframe className='w-screen aspect-video ' src="https://www.youtube.com/embed/QcOED9rj7Qw?si=hsMbArFpFNXSI5ik&amp;controls=0&amp;start=14&mute=1&autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
