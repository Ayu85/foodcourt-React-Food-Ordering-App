...
const Secondarysection = () => {
  return (
    <div className='flex justify-between px-20 pt-20 py-10 bg-gradient-to-l from-[#FEBEA3]'>
      ...
      <div className='flex gap-10'>
        <img src={instantfood} alt='instant food ' className='w-48 h-72 rounded-3xl shadow-2xl shadow-[#fbaaa8]' />
        <img src={delivery} alt='instant food ' className='w-48 h-72 rounded-3xl mt-12 shadow-2xl shadow-[#fba9a8a4]' />
        <img src={menufood} alt='instant food ' className='w-48 h-72 rounded-3xl shadow-2xl shadow-[#fbaaa8]' />
