...
const Herosection = () => {
    return (
        <div className='relative bg-gradient-to-l from-[#FFD5D4] to-[#FFF4F3] gap-5 h-[100vh] flex justify-between items-center '>
            ...
            <div className='absolute top-20  lg:right-[750px] sm:right-44 right-44 hidden md:block lg:block'><ImLocation2 className='text-8xl text-[#F64E61] animate-[bounce_2s_ease-in-out_infinite] ' />
            </div>
            <div className=' lg:max-w-[500px] lg:pl-20 sm:pr-14 sm:pl-10  pl-5 pr-5 z-50 '>
